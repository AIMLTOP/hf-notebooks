...
def main(hub_args):
    ...
    training_args.push_to_hub = hub_args.push_to_hub
    training_args.hub_strategy = hub_args.hub_strategy
    training_args.hub_model_id = hub_args.hub_model_id
    training_args.hub_token = hub_args.hub_token
    ...
    if training_args.do_train:
        ...
        push_to_hub(trainer, hub_args.hub_model_id)
